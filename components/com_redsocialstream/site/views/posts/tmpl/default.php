...
<script language='javascript'>
	$(document).ready(function (evt) {
		var url = site_url + 'index.php?option=com_redsocialstream&format=raw&view=posts&task=save&groupid=' + '<?php echo $this->groupid; ?>' + '&limit=' + '<?php echo $this->limit; ?>' + '&orderby=' + '<?php echo $this->orderby; ?>' + '<?php if($this->profiletypeid != "" ){ echo "&profiletypeid=".$this->profiletypeid;}?>';
		var data = '';
		var request = new Request({
			...
			onSuccess: function (responseText) {
				var url = site_url + 'index.php?option=com_redsocialstream&format=raw&view=posts&task=getajaxposts&groupid=' + '<?php echo $this->groupid; ?>' + '&limit=' + '<?php echo $this->limit; ?>' + '&orderby=' + '<?php echo $this->orderby; ?>' + '<?php if($this->profiletypeid != "" ){ echo "&profiletypeid=".$this->profiletypeid;}?>';

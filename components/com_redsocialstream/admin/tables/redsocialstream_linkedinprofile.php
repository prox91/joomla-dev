...
class Tableredsocialstream_linkedinprofile extends JTable
{
//inside this class we must have one variable for each field of our table, and for every added column or removed column in our //table, we must add or remove the variable in that class.
	var $id = null;
	var $profile_id = null;
	var $linkedin_access_oauth_token = null;
	var $linkedin_access_oauth_token_secret = null;
	var $linkedin_oauth_verifier = null;
	...
	{
		$this->_table_prefix = '#__redsocialstream_linkedin_connections';

...
include(JPATH_BASE . "/components/com_redtwitter/lib/twitteroauth/config.php");
include(JPATH_BASE . "/components/com_redtwitter/lib/twitteroauth/OAuth.php");
include(JPATH_BASE . "/components/com_redtwitter/lib/twitteroauth/twitteroauth.php");

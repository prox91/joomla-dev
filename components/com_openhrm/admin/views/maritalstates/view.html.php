...
class OpenHrmViewMaritalStates extends OpenHrmViewAdmin
{
    ...
    public function getToolbar()
    {
        ...
        if ($user->authorise('core.admin', 'com_openhrm.panel'))
        {
            ...
            {
                $new = RToolbarBuilder::createNewButton('maritalstate.add');
                $edit = RToolbarBuilder::createEditButton('maritalstate.edit');
                $firstGroup->addButton($new)
                    ->addButton($edit);
            }

            $publish =  RToolbarBuilder::createPublishButton('maritalstates.published');
            $unpublish =  RToolbarBuilder::createPublishButton('maritalstates.unpublished');
            ...
            {
                $delete = RToolbarBuilder::createDeleteButton('maritalstates.delete');

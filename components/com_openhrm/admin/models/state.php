...
class OpenHrmModelState extends JModelAdmin
{
	/**
	...
	{
		$form = $this->loadForm('com_openhrm.state', 'state', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_openhrm.edit.state.data', array());

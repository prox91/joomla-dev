...
CREATE TABLE IF NOT EXISTS `#__ec_lessons_grammars` (
  ...
  `text_explain` text,
  `text_trans` text,
  `ks_no` varchar (50) NOT NULL DEFAULT 0 COMMENT 'key structure number of lesson',
  `ks_no_ref` varchar (50) NOT NULL DEFAULT 0 COMMENT 'related key structure number of lesson',
  `created` datetime DEFAULT '0000-00-00 00:00:00',
  `created_by` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `modified` datetime DEFAULT '0000-00-00 00:00:00',
  `modified_by` int(11) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__ec_lessons_usages` (
  ...
  `text_trans` text,
  `text_explain` text,
  `ds_no` varchar (50) NOT NULL DEFAULT 0 COMMENT 'different special of lesson',
  `ds_no_ref` varchar (50) NOT NULL DEFAULT 0 COMMENT 'related different special of lesson',
  `created` datetime DEFAULT '0000-00-00 00:00:00',
  `created_by` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `modified` datetime DEFAULT '0000-00-00 00:00:00',
  `modified_by` int(11) UNSIGNED NOT NULL DEFAULT 0,

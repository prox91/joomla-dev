    ...
    <div id="ec-panel-right" class="span10">
        <div class="ec-main-container">
            <script type="text/javascript">
                ...
                {
                    if (task == 'level.cancel' || document.formvalidator.isValid(document.id('itemForm')))
                    {
            ...
            <form enctype="multipart/form-data"
                action="<?php JRoute::_('index.php?option=com_englishconcept&view=level'); ?>" method="post" name="itemForm" id="itemForm"

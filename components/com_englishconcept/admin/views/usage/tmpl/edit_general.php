...
(function ($) {
    ...
    //$('#advancedSelect').trigger('chosen:updated');
}(jQuery));
...
(function ($) {
    $('#advancedSelect').ajaxChosen({
            dataType: 'json',
            type: 'POST',
            url:'<?php echo JRoute::_('index.php?option=com_englishconcept&view=usage&task=usage.searchAjax')?>'
        },
        function (data) {
            var results = [];
...
//            type: 'GET',
//            url: 'http://localhost/englishconcept/index.php?option=com_tags&task=tags.searchAjax',
//            dataType: 'json',
//            jsonTermKey: 'like',
//            afterTypeDelay: '500',
//            minTermLength: '3'
...
//        var tab = $('<li class=""><a href="#publishing" data-toggle="tab">Publishing</a></li>');

...
{
	$link = JRoute::_('index.php?option=com_englishconcept&task=grammarexercisequestion.apply&view=grammarexercisequestion&tmpl=component&layout=modal&exercise_id=' . $exerciseId . '&id=' . $this->item->id);
}
else
{
	$link = JRoute::_('index.php?option=com_englishconcept&task=grammarexercisequestion.apply&view=grammarexercisequestion&tmpl=component&layout=modal&exercise_id=' . $exerciseId);
}
?>
				...
				<fieldset class="adminform" id="general-tab">
					...
					<div class="control-group">
						<a id="new-question-tier" class="btn">
							...
							<?php echo JText::_('EC_GRAMMAR_EXERCISE_QUESTION_NEW_QUESTION')?>
						</a>
						<div class="clearfix"></div>
						<table id="comprehension_question_tbl" class="table" cellspacing="0">
							<thead>
							<tr>
								<th width="2%"><?php echo JText::_('EC_GRAMMAR_EXERCISE_QUESTION_ACTION'); ?></th>
								<th width="8%"><?php echo JText::_('EC_GRAMMAR_EXERCISE_QUESTION_NUM'); ?></th>
								<th width="90%"><?php echo JText::_('EC_GRAMMAR_EXERCISE_QUESTION_TITLE'); ?></th>
							</tr>
							</thead>

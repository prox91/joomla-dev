				...
				<table id="adminLessonList" class="table table-striped">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								<a href="<?php echo JRoute::_('index.php?option=com_englishconcept&task=comprehension.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
							...
							<td class="center">
								...
								<?php echo JHtml::_('jgrid.published', $item->published, $i, 'comprehensions.', 'cb'); ?>
							</td>
							<td class="center">

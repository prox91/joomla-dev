...
<div class="ec-contain">
	...
	<div id="ec-panel-right" class="span10">
		<form action="<?php echo JRoute::_('index.php?option=com_englishconcept&view=lessons'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table id="adminLessonList" class="table table-striped">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								<a href="<?php echo JRoute::_('index.php?option=com_englishconcept&task=lesson.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
									<?php echo $item->lesson_no . ' - ' .$this->escape($item->title); ?></a>
							</td>
							<td>

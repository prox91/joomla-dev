...
$isInfosys    = $params->get('assign_to_infosys');

// Store category list into session
$sesson = JFactory::getSession();
if($isInfosys)
{
    $sesson->set('categoryIdList_Infosys', $categoryList, 'SearchModule');
}
else
{
    $sesson->set('categoryIdList', $categoryList, 'SearchModule');
}

require JModuleHelper::getLayoutPath('mod_redcontent_search', $params->get('layout', 'default'));

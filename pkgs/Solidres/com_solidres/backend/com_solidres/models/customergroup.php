...
class SolidresModelCustomerGroup extends JModelAdmin
{
	...
	protected function loadFormData()
	{
		...
		$results = $dispatcher->trigger('onContentPrepareData', array('com_solidres.customergroup', $data));
	...
	public function getItem($pk = null)
	{
        ...
        // Trigger the data preparation event.
        $results = $dispatcher->trigger('onContentPrepareData', array('com_solidres.customergroup', $item));

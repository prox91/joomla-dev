 ...
 * @since		0.1.0
 */
class SolidresViewCategory extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		if($isNew)
        {
			JToolBarHelper::title(JText::_('SR_ADD_NEW_RESERVATION_ASSET_CATEGORY'), 'generic.png');
		}
        else
        {
			JToolBarHelper::title(JText::_('SR_EDIT_RESERVATION_ASSET_CATEGORY'), 'generic.png');
		}
		...
		JToolBarHelper::help('screen.category.edit','JTOOLBAR_HELP');
	}
}

		...
		<div id="sr_panel_right" class="sr_form_view span10">
			<div class="sr-inner">
				...
				jQuery(document).ready(function($) {
					...
					{
					if (task == 'category.cancel' || jQuery('#item-form').valid())
						{
				...
				<form enctype="multipart/form-data" action="<?php JRoute::_('index.php?option=com_solidres&view=categories'); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal">

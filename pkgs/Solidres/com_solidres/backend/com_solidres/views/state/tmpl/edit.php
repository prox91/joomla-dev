...
<div id="solidres">
	...
	<div id="sr_panel_right" class="sr_form_view span10">
		<div class="sr-inner">
			...
			{
				if (task == 'state.cancel' || jQuery('#item-form').valid())
				{
			...
			<form enctype="multipart/form-data" action="<?php JRoute::_('index.php?option=com_solidres&view=states'); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal">

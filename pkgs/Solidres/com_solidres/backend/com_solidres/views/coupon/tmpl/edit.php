    ...
    <div class="row-fluid">
		...
		<div id="sr_panel_right" class="sr_form_view span10">
				<div class="sr-inner">
					...
					{
						if (task == 'coupon.cancel' || jQuery('#item-form').valid()) 
						{
				...
				<form enctype="multipart/form-data" action="<?php JRoute::_('index.php?option=com_solidres&view=coupons'); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal">

...
<div id="solidres">
    <div class="row-fluid">
		...
		<div id="sr_panel_right" class="sr_list_view span10">
			<form action="<?php echo JRoute::_('index.php?option=com_solidres&view=currencies'); ?>" method="post" name="adminForm" id="adminForm">
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<th class="title">
								<?php echo JHtml::_('grid.sort',  'SR_CURRENCY_NAME', 'u.currency_name', $listDirn, $listOrder); ?>
							</th>
							<th>
								<?php echo JHtml::_('grid.sort',  'SR_CURRENCY_PUBLISHED', 'u.state', $listDirn, $listOrder); ?>
							</th>
							<th>
								<?php echo JHtml::_('grid.sort',  'SR_CURRENCY_CODE', 'u.currency_code', $listDirn, $listOrder); ?>
							</th>							
							<th>
								<?php echo JHtml::_('grid.sort',  'SR_CURRENCY_EXCHANGE_RATE', 'u.exchange_rate', $listDirn, $listOrder); ?>
							</th>
						</tr>
		                <tr class="filter-row">
		                    <th></th>

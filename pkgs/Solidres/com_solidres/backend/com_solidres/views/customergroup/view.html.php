 ...
 * @since		0.1.0
 */
class SolidresViewCustomerGroup extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
        ...
        {
			JToolBarHelper::title(JText::sprintf('SR_EDIT_CUSTOMERGROUP', $this->item->name), 'generic.png');
		}
		...
		JToolBarHelper::help('screen.customergroup.edit','JTOOLBAR_HELP');
	}
}

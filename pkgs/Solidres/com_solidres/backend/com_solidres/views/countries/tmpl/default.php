...
<div id="solidres">
    <div class="row-fluid">
		...
		<div id="sr_panel_right" class="sr_list_view span10">
			<form action="<?php echo JRoute::_('index.php?option=com_solidres&view=countries'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<thead>
						<tr>
							...
							<!--<th width="10%" nowrap="nowrap">
								<?php echo JHtml::_('grid.sort',  'SR_HEADING_ORDERING', 'r.ordering', $listDirn, $listOrder); ?>
								<?php echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'room.saveorder'); ?>
							</th>
							-->
						</tr>
		                <tr class="filter-row">

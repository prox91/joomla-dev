...
$action    = JRoute::_('index.php?option=com_jab&view=speakers');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$saveOrder = $listOrder == 'ordering';

$saveOrderingUrl = 'index.php?option=com_jab&task=speakers.saveOrderAjax&tmpl=component';
	...
	<div class="">
		...
		<table class="table table-striped table-hover" id="articleList">
			...
			<tr>
				...
				<th class="name">
					<?php echo JHtml::_('rgrid.sort', 'COM_JAB_SPEAKER_NAME_LABEL', 's.name', $listDirn, $listOrder); ?>
				</th>
				<th width="10%">
					<?php echo JHtml::_('rgrid.sort', 'JPUBLISHED', 's.state', $listDirn, $listOrder); ?>
				</th>
				<th width="10%">
					<?php echo JHtml::_('rgrid.sort', 'JGRID_HEADING_LANGUAGE', 'language', $listDirn, $listOrder); ?>
				</th>
				<th width="1%" class="id">
					<?php echo JHtml::_('rgrid.sort', 'COM_JAB_ID', 's.id', $listDirn, $listOrder); ?>
				</th>
			</tr>
			</thead>
			<?php if ($this->items): ?>
				...
				<?php foreach ($this->items as $i => $item): ?>
					...
					<tr class="row&lt;?php echo $i%2; ?&gt;">
						...
						<td>
							<a href="<?php echo JRoute::_('index.php?option=com_jab&task=speaker.edit&id=' . $item->id); ?>">
								<?php echo $this->escape($item->name); ?>
							</a>
						</td>
						<td>
							<?php echo JHtml::_('rgrid.published', $item->published, $i, 'speakers.', $canChange, 'cb'); ?>
						</td>
						<td>

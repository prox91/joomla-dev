		...
		<table class="table table-striped table-hover" id="articleList">
			<thead>
				...
				<tr>
					...
					<th class="name">
						<?php echo JHtml::_('rgrid.sort',  'COM_JAB_NAME_LABEL', 'c.name', $listDirn, $listOrder); ?>
					</th>
					<th width="5%">
						<?php echo JHtml::_('rgrid.sort',  'JPUBLISHED', 'c.state', $listDirn, $listOrder); ?>
					</th>
					<th width="10%">
						<?php echo JHtml::_('rgrid.sort', 'JGRID_HEADING_LANGUAGE', 'language', $listDirn, $listOrder); ?>
					</th>
					<th width="1%" class="id">
						<?php echo JHtml::_('rgrid.sort',  'COM_JAB_ID', 'c.id', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<?php if ($this->items): ?>
				<tbody>
					<?php foreach ($this->items as $i => $item): ?>
						...
						<tr class="row&lt;?php echo $i%2; ?&gt;">
							...
							<td class="center">
								<?php echo JHtml::_('rgrid.published', $item->published, $i, 'countries.', $canChange, 'cb'); ?>
							</td>
							<td class="center">

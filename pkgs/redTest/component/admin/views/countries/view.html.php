 ...
 * @since       1.0
 */
class JabViewCountries extends JabView
{
	...
	{
		return JText::_('COM_JAB_COUNTRY_LIST_TITLE');
	}
	...
	public function getToolbar()
	{
		...
		if ($user->authorise('core.admin', 'com_jab.panel'))
		{
			...
			{
				$publish = RToolbarBuilder::createPublishButton('countries.publish');
				$unpublish = RToolbarBuilder::createUnpublishButton('countries.unpublish');
